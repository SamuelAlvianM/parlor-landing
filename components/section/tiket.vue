...
<div class="relative max-w-6xl mx-auto px-6 md:px-8 lg:px-12">
  ...
  >
    ...
    >
      ...
      >
        <h3 class="text-xl md:text-2xl font-bold text-gray-800 text-center">
          {{ paket.nama }}
        </h3>

        <div class="mt-6 w-full flex flex-col sm:flex-row justify-center gap-4">
          <div
            class="w-full sm:w-40 px-4 py-2 bg-green-500 text-white text-sm md:text-base font-semibold rounded-lg text-center"
          >
